...
# 2019-01-19
"""
Convert Pascal VOC data to TFRecords file format with Example protos.
...
This TensorFlow script converts the training and evaluation data into a shared
dataset consisting of 1024 and 128 TFRecord files, respectively.
...
# Original dataset organizations:
...
def _process_image(directory, name):
    ...
    :param directory: string, path to an image file e.g., '/path/to/example.JPG'.
    """
    # Read the image file.
...
def _add_to_tfrecord(dataset_dir, name, tfrecord_writer):
    """Loads data from image and annotation files and add them to a TFRecord.
    ...
    exampel = _convert_to_example(image_data, labels, labels_text,
                                  bboxes, shape, difficult, truncated)
    tfrecord_writer.write(exampel.SerializeToString())
